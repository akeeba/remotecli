...
use Akeeba\RemoteCLI\Api\Exception\NoDownloadMode;
use Akeeba\RemoteCLI\Api\Exception\NoDownloadPath;
use Akeeba\RemoteCLI\Api\Exception\NoDownloadURL;
 ...
 * @since 3.0.0
 */
class DownloadOptions extends DataObject
{
